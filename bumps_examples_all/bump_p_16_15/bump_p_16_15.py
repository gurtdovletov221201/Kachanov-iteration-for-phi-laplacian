...
plt.loglog(costs, ref_line, "k-", label=r"$50 \times \text{cost}^{-1}$")

plt.xlabel("cost")
plt.legend(loc="lower left")
plt.tight_layout()
plt.savefig("bump_p_16_15.png", dpi=200)